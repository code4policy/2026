...
Video  | Reading| Coding | Project
-------|-------|-------|-------|
--- | [Agile 2 reading](https://github.com/code4policy/modules/blob/master/agile/07-reading2.md) before David Eaves (Thursday)| --- | Focus on Projects! (Section B: Bring a Hat to class 🧢)
...
[dataviz-with-gpt](https://classroom.github.com/a/NH-12Oxd)| Dataviz with ChatGPT

### Async

Video  | Reading| Coding | Project
-------|-------|-------|-------|
-- | Atlantic [article about healthcare.gov](https://www.theatlantic.com/technology/archive/2015/07/the-secret-startup-saved-healthcare-gov-the-worst-website-in-america/397784/)|--|Work on Sprint 2!
